...
public static function getPostImageUrl(){
	global $post;
	 ...
	 $imgsrc=str_replace('http://m.freesweetsweeps', 'http://freesweetsweeps', $imgsrc);
	 return $imgsrc;
}

public function get_index_post_image(){
	if(1==2){
	if(Images::get_post_thumbnail_url('post', 'index-image')!=""){
	$imgsrc=Images::get_post_thumbnail_url('post', 'index-image');
	}
	else{
	$imgsrc=Images::get_featured_image();
	}
	}
	else{
		$imgsrc=Images::get_featured_image();
...
public function get_featured_image(){
	$image = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'post-image'); $img=$image[0];
	return $img;
}

public function get_thumb_150(){
...
public static function get_facebook_image_url(){
	  ...
	  if (class_exists('Images')) {
			  ...
			  else if(Images::get_thumb_150()!=""){
			  $imgsrc=Images::get_thumb_150();
			  }
			  else if(Images::get_featured_image()!=""){
			  $imgsrc=Images::get_featured_image();
			  }
...
public static function get_pinterest_image_url(){
	global $post;
	  if (class_exists('Images')) {
			  ...
			  else if(Images::get_post_thumbnail_url('post', 'index-image')!=""){
	          $imgsrc=Images::get_post_thumbnail_url('post', 'index-image');
			  }
			  else if(Images::get_featured_image()!=""){
			  $imgsrc=Images::get_featured_image();
...
public function register($args = array()) {
       ...
       private function theme_url($relative_path) {
			$url=get_template_directory_uri();
